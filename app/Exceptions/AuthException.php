...
{       
   ...
   {
        return static::new(
            StatusCode::UserIsAlreadyRegistered,
        );
   }
   ...
   {
        return static::new(
            StatusCode::InvalidUserCredential,
        );
   }
   ...
   {
        return static::new(
            StatusCode::UserEmailAlreadyTaken,
        );
   }
   ...
   {
        return static::new(
            StatusCode::IncorrectLoginPassword,
        );
   }
   ...
   {
        return static::new(
            StatusCode::IncorrectRetypePassword,
        );
   }
   ...
   {
        return static::new(
            StatusCode::UserRegistrationFailed,
        );
   }

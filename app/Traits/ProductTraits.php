...
trait ProductTraits
{
     ...
     * @return array
     */
    protected function createProduct($request): array
    {
     ...
     * @return Supplier
     */
    protected function handleSupplier(array $supplierData): Supplier
    {
        // creates new supplier if not exists
        return $this->supplier->firstOrCreate([
     ...
     * @return Product
     */
    protected function handleProduct(array $productData, $relations): Product
    {
     ...
     */
    protected function handleProductType(array $data, $relations): ProductCategories|Collection
    {
        // create new product main type
        $mainType = $this->type->firstOrCreate(['type_name' => $data['type']]);
     ...
     * @return array
     */
    protected function updateProduct($request, Product $product): array
    {
        $validated = $request->safe();
     ...
     * @return Product
     */
    protected function updateProductDetails(Product $product, array $productData, array $relations): Product
    {
        // Update product details
        $product->update([
     ...
     * @return Supplier
     */
    protected function updateOrKeepSupplier(?Supplier $supplier, array $supplierData): Supplier
    {
     ...
     * @return bool
     */
    protected function supplierDataChanged(Supplier $supplier, array $supplierData): bool
    {
     ...
     * @return array
     */
    protected function updateOrKeepProductTypes(Product $product, array $typeData): array
    {
     ...
     * @return array
     */
    protected function getExistingCategories($product, $subtypes)
    {
     ...
     */
    protected function handleProductCategoryUpdate($product, array $attribute): void
    {
        // Add new categories
     ...
     * @return bool
     */
    protected function typeDataChanged(Product $product, array $typeData): bool
    {
